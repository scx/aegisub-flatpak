...
```
$ flatpak --user remote-add --no-gpg-verify "aegisub-wxgtk3" "repo"
```

```
$ flatpak --user install "aegisub-wxgtk3" "org.aegisub.Aegisub"
```
...
```
$ flatpak --user remote-delete "aegisub-wxgtk3"
```
